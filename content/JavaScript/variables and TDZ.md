...
var / let / const의 차이는 Creation Phase에서 변수의 초기화 방식이 다르기 때문에 발생한다.
...
다음 글에서는 **JavaScript 엔진은 변수를 어떻게 찾아낼까?** — Execution Context 내부의 핵심 구조인 Lexical Environment와 Scope Chain으로 이어서 정리해보겠다. 🚀
