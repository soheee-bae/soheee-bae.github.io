...
JavaScript는 어떻게 변수를 찾을까?
Lexical Environment & Scope Chain 완전 이해
...
여기서 변수 탐색의 핵심 역할을 하는 것이 바로
👉 Lexical Environment다.
...
Environment Record에 변수 저장

Outer Reference로 상위 스코프 연결

Scope Chain을 따라 변수 탐색

결국 JavaScript는

가장 가까운 스코프부터 차례대로 변수를 찾는다.
